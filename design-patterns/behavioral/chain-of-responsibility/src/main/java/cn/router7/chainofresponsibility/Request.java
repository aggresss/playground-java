...
public class Request {
    ...
    /**
     * The type of this request, used by each item in the chain to see if they
    ...
    /**
     * Indicates if the request is handled or not. A request can only switch state
     * from unhandled to handled, there's no way to 'unhandle' a request.
     */
    ...
    /**
     * Get the type of this request, used by each person in the chain of command to
