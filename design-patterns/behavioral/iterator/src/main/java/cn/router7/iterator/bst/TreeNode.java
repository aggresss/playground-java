package cn.router7.iterator.bst;

/**
 * TreeNode Class, representing one node in a Binary Search Tree. Allows for a
 * generically typed value.
 *
 * @param <T> generically typed to accept various data types for the val
 *            property
 */
public class TreeNode<T extends Comparable<T>> {
    ...
    /**
     * Inserts new TreeNode based on a given value into the subtree represented by
     * self.
     *
     ...
     * maintaining the integrity of the BST.
     *
     * @param value The value of the TreeNode that would be inserted beneath self
     * @return The child TreeNode of self which represents the subtree where `value`
     *         would be inserted
     */
    ...
    /**
     * Add a new Child TreeNode of given value to self. WARNING: This method is
     * destructive (will overwrite existing tree structure, if any), and should be
     * called only by this class's insert() method.
     *
     * @param valToInsert Value of the new TreeNode to be inserted
     */
